...
START_TEST (tu_local)
{
  ...
  tm_setlocalwallclock ("Europe/Berlin");
  ck_assert (!tm_isdefinedinlocaltime (dt));
  tm_print (dt, __LINE__);
}
...
START_TEST (tu_diff_local)
{
  ...
  ck_assert (tm_diffseconds (debut, fin) ==
             (30 + 31 + 31 + 29 + 31 + 30 + 31 + 30) * 24 * 3600 - 12 * 24 * 3600 - 2 * 3600 - 3600 + 57);
...
START_TEST (tu_diff_utc)
{
  ...
  ck_assert (tm_diffseconds (debut, fin) ==
             (30 + 31 + 31 + 29 + 31 + 30 + 31 + 30) * 24 * 3600 - 12 * 24 * 3600 - 2 * 3600 - 50);
  ck_assert (tm_diffcalendardays (debut, fin) == (30 + 31 + 31 + 29 + 31 + 30 + 31 + 30) - 12);
  ck_assert (tm_diffdays (debut, fin, &s) == (30 + 31 + 31 + 29 + 31 + 30 + 31 + 30) - 12 - 1);
...
START_TEST (tu_change_timezone)
{
  ...
  tm_setlocalwallclock ("Europe/Kiev");
  struct tm ki;
  ...
  tm_changetowallclock (&ki, "Australia/Adelaide");
  tm_print (ki, __LINE__);
  ck_assert (tm_tostring (ki, sizeof (str) / sizeof (*str), str) == TM_OK);
  ...
  tm_changetowallclock (&ki, "America/Los_Angeles");
  ...
  tm_changetowallclock (&ki, "Europe/Paris");
  ...
  tm_changetowallclock (&ki, "Pacific/Kiritimati");
  ck_assert (tm_getutcoffset (ki) == 14 * 3600);
  tm_changetowallclock (&ki, "Pacific/Tahiti");
...
START_TEST (tu_iso8601)
{
  ...
  ck_assert (tm_set (&control, 2019, 8, 21, 0, 0, 0, TM_REF_LOCALTIME) == TM_OK &&
             tm_setfromiso8601 (&dt, "2019-08-21") == TM_OK &&
             tm_equals (dt, control) &&
             tm_toiso8601 (dt, 49, str) == TM_OK && strcmp (str, "20190821T000000+0200") == 0);
  ck_assert (tm_set (&control, 2019, 8, 22, 0, 0, 0, TM_REF_LOCALTIME) == TM_OK &&
             tm_setfromiso8601 (&dt, "2019−08−22") == TM_OK &&
             tm_equals (dt, control) &&
             tm_toiso8601 (dt, 49, str, 1) == TM_OK && strcmp (str, "2019-08-22T00:00:00+0200") == 0);
  ck_assert (tm_set (&control, 2019, 8, 23, 0, 0, 0, TM_REF_LOCALTIME) == TM_OK &&
             tm_setfromiso8601 (&dt, "20190823") == TM_OK &&
             tm_equals (dt, control) &&
             tm_toiso8601 (dt, 49, str) == TM_OK && strcmp (str, "20190823T000000+0200") == 0);
  ck_assert (tm_set (&control, 2019, 8, 24, 1, 2, 3, TM_REF_LOCALTIME) == TM_OK &&
             tm_setfromiso8601 (&dt, "20190824T010203") == TM_OK &&
             tm_equals (dt, control) &&
             tm_toiso8601 (dt, 49, str) == TM_OK && strcmp (str, "20190824T010203+0200") == 0);
  ck_assert (tm_set (&control, 2019, 8, 25, 3, 32, 3, TM_REF_UTC) == TM_OK &&
             tm_setfromiso8601 (&dt, "20190825T010203−0230") == TM_OK &&
             tm_equals (dt, control) &&
             tm_toiso8601 (dt, 49, str, 1) == TM_OK && strcmp (str, "2019-08-25T03:32:03+0000") == 0);
  ck_assert (tm_set (&control, 2019, 8, 26, 9, 30, 0, TM_REF_UTC) == TM_OK &&
             tm_setfromiso8601 (&dt, "20190826T07-0230") == TM_OK &&
             tm_equals (dt, control) &&
             tm_toiso8601 (dt, 49, str) == TM_OK && strcmp (str, "20190826T093000+0000") == 0);
  ck_assert (tm_set (&control, 2019, 8, 27, 1, 2, 3, TM_REF_LOCALTIME) == TM_OK &&
             tm_setfromiso8601 (&dt, "20190827T010203.123456789+0200") == TM_OK &&
             tm_equals (dt, control) &&
             tm_toiso8601 (dt, 49, str) == TM_OK && strcmp (str, "20190827T010203+0200") == 0);
  ck_assert (tm_set (&control, 2019, 8, 28, 1, 2, 3, TM_REF_UTC) == TM_OK &&
             tm_setfromiso8601 (&dt, "20190828T010203,000Z") == TM_OK &&
             tm_equals (dt, control) &&
             tm_toiso8601 (dt, 49, str) == TM_OK && strcmp (str, "20190828T010203+0000") == 0);
}
...
START_TEST (tu_localwallclock)
{
  ...
  dt_tokyo = dt_paris;
  tm_changetowallclock (&dt_tokyo, "Asia/Tokyo");
  ...
  tm_setlocalwallclock ("America/Santiago");
...
mm_suite (int is_TZ_owner)
{
  ...
  {
    case_name = "Tests";
    unckecked_setup = unckecked_setup_is_not_TZ_owner;
  }
  else
  {
    case_name = "Tests optimized";
    unckecked_setup = unckecked_setup_is_TZ_owner;
  }
