...
tm_status tm_make_dtrc (struct tm *dt, int year, tm_month month, int day, int hour, int min, int sec, const char *,
                        tm_time_precedence);
...
#  define dt_set1(date)                           tm_make3 (date, TM_TODAY, TM_REF_UTC)
